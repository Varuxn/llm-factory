...
train_data = os.path.join(project_path, "/processed_data/QA_exp.txt")
chongshu_data = os.path.join(project_path, "/processed_data/QA_exp_v2.json")
...
output_path = os.path.join(project_path, "/processed_data/QA_exp_merge.json")
